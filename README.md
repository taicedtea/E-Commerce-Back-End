...
## Description
This is an backend application for companies to track products in stock, including specifications and quantity in stock. Created using Express.js and mySQL.
